...
export const store = new Vuex.Store({
  ...
  mutations: {
    ...
    registration(state) {
      ...
      console.log("state.productImages.product_image_2: ", state.productImages.product_image_2)
      console.log("state.productImages.product_image_3: ", state.productImages.product_image_3)
      console.log("state.productImages.product_image_4: ", state.productImages.product_image_4)
      console.log("state.productImages.product_image_5: ", state.productImages.product_image_5)
      console.log("state.productImages.product_image_1: ", state.productImages.product_image_1)
    }
  },
